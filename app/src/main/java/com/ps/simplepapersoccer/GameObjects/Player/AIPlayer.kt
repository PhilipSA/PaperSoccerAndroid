...
abstract class AIPlayer(playerName: String, playerNumber: Int, playerColor: Int) :
    ...
    companion object {
        ...
        fun createAi(context: Context?,
            ...
            NeuralNetworkAI::class.java.simpleName -> NeuralNetworkAI(context, playerNumber, playerColor)
            AlphaZeroAI2::class.java.simpleName -> AlphaZeroAI2(playerNumber, playerColor)
